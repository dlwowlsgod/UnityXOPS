...
public struct CharacterInfo
{
    ...
    /// </summary>
    public CharacterArmorFlag ArmorDamageFlag;

    /// <summary>
    /// 캐릭터의 헬멧이 감소시키거나 막아주는 데미지 타입을 정의합니다.
    /// </summary>
    public CharacterArmorFlag HelmetDamageFlag;
    ...
    public static CharacterInfo Null => new()
    {
        ...
        ArmorDamageFlag = CharacterArmorFlag.None,
        HelmetDamageFlag = CharacterArmorFlag.None
    };
}