...
namespace UnityXOPS
{
    ...
    public static class ProfileLoader
    {
        ...
        private static readonly List<string> ProfileData = new()
        {
            ...
            "",
            "; Require directory and extension for official mission txt files.",
            "UseBriefingFolderForMissionTxt = false",
            "",
            "[Time]",
            "; Set fixed timestep.",
            "; Under 30 force set to 30.",
            "; Over 60 not allowed due to performance issue. (hard CPU overhead)",
            "FixedFrameRate = 30",
            "",
            "; Set timestep.",
            "; Under 60 force set to monitor frame rate.",
            "FrameRate = 0"
        };
